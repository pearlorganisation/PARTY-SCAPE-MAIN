            ...
            <div className="col-12">
              ...
              >
                <p className="wow fadeInUp" data-wow-delay=".6s">
                  ...
                  "us", "our" used anywhere on this page shall mean PARTYSCAPE,
                  whose registered/operational office is 8-1-284/OU/385/1&2, 4th
                  Floor, OU Colony, Shaikpet, Hyderabad Hyderabad TELANGANA
                  500008 . "you", “your”, "user", “visitor” shall mean any
                ...
                <ul className="wow fadeInUp" style={{listStyleType: "inherit"}} data-wow-delay=".6s">
                  <li>
                  ...
                  <li>
                    ...
                    website or document without PARTYSCAPE’s prior written
                    consent.
                  </li>
                  <li>
